    ...
    <section id="blog" class="fondblog">
        ...
        <div id="actualite">
            <article class="card" id="article1">
                <a href="bloglien1.php"><img src="images/photo_instagram1_ld.jpg" alt="photo_instagram1"
                        style="width:100%"></a>
                <div class="card_container">
                    <h4>02 Nov 2021 par John Doe</h4>
                    <h5>Nouveau menu ! Venez découvrir</h5>
                    <div class="lienblog">
                        <a href="bloglien1.php">En savoir plus</a>
                        <!-- bouton commentaire ouvre une boite de dialogue -->
            ...
            <article class="card" id="article2">
                <a href="bloglien2.php"><img src="images/photo_instagram2_ld.jpg" alt="photo_instagram2"
                        style="width:100%"></a>
                <div class="card_container">
            ...
            <article class="card" id="article3">
                <a href="bloglien3.php"><img src="images/photo_instagram3_ld.jpg" alt="photo_instagram3"
                        style="width:100%"></a>
                <div class="card_container">
                    <h4>15 Oct 2021 par John Doe</h4>
                    <h5>La carte change !</h5>
                    <div class="lienblog">
                        <a href="bloglien3.php">En savoir plus</a>
            ...
            <article class="card" id="article4">
                <a href="bloglien4.php"><img src="images/photo_instagram4_ld.jpg" alt="photo_instagram4"
                        style="width:100%"></a>
                <div class="card_container">
                    <h4>3 Oct 2021 par John Doe</h4>
                    <h5>Découvrez la nouvelle terrasse !</h5>
                    <div class="lienblog">
                        <a href="bloglien4.php">En savoir plus</a>
            ...
            <article class="card" id="article5">
                <a href="bloglien5.php"><img src="images/photo_instagram5_ld.jpg" alt="photo_instagram5"
                        style="width:100%"></a>
                <div class="card_container">
                    <h4>15 Sep 2021 par John Doe</h4>
                    <h5>Le site internet évolue !</h5>
                    <div class="lienblog">
                        <a href="bloglien5.php">En savoir plus</a>
            ...
            <article class="card" id="article6">
                <a href="bloglien6.php"><img src="images/photo_instagram6_ld.jpg" alt="photo_instagram6"
                        style="width:100%"></a>
                <div class="card_container">
                    <h4>2 Sep 2021 par John Doe</h4>
                    <h5>Le menu moussaillon en détails !</h5>
                    <div class="lienblog">
                        <a href="bloglien6.php">En savoir plus</a>
